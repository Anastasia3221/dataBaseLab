...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Мар 21 2023 г., 18:21
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `getBooks` (INOUT `bookNamesList` VARCHAR(4000), IN `publishedYear` INT)  BEGIN
...
-- Функции
--
CREATE DEFINER=`root`@`localhost` FUNCTION `avgPrice` (`yearParam` INT) RETURNS DECIMAL(10,0) RETURN (
